...
const shoot_cooldown = [2, 0.7, 0.4, 0.15, 0.1]    # wartości są troszkę niezgodne z opisem bo shoot coldown small oznacza że powinien często strzelać a strzela wtedy rzadko, jest tak dlatego aby na wykresach postacie z wysoką szybkostrzelnością miały więcej punkcików
const bullet_speed = [1, 800, 1600, 2200, 2800]
const bullet_damage = [1, 15, 30, 60, 30]
const bullet_range = [1, 400, 1250, 2250, 10000]
